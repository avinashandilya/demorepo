...
public class Assignment3_LoginPage {
 ...
 Write a Test Script to Automate https://www.saucedemo.com/index.html Login   using Page Object Model 
  ...
  -USe properties files to store Data and Objects */
	...
	public Assignment3_LoginPage(WebDriver driver) {
		this.driver=driver;
	}
	...
	{
		prop = new Properties();
		FileInputStream ip = new FileInputStream("E:\\Selenium Training\\seleniumProject\\src\\test\\java\\module11\\Assignment3.properties");
		prop.load(ip);
